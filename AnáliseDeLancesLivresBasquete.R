...
FreeThrowAttempt <- rbind(KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA, CarmeloAnthony_FTA, DwightHoward_FTA, ChrisBosh_FTA, ChrisPaul_FTA, KevinDurant_FTA, DerrickRose_FTA, DwayneWade_FTA)
...
rownames(FreeThrowAttempt) <- Players
...
# Number of attempts by game
plotting(FreeThrowAttempt/Games)

# free throw accuracy
plotting(FreeThrow/FreeThrowAttempt)

# Game style (except free throws)
plotting((Points-FreeThrow)/FieldGoals)
